    ...
    <main className="min-h-screen px-6 py-8 sm:px-10">
      <section className="mx-auto w-full max-w-5xl">
        <nav className="flex items-center justify-between">
          ...
          <Link href="/" className="text-sm font-semibold text-[#be4b49]">
            홈으로
          </Link>
        </nav>
        ...
        <header className="py-10">
          ...
          <p className="mt-4 max-w-2xl leading-7 text-[#52616b]">
            지금은 샘플 데이터로 구성된 최소 버전입니다. 이후 검색, 장르
        ...
        <div className="grid gap-4 md:grid-cols-3">
          {reviews.map((review) => (
            <Link
              ...
              className="rounded-lg border border-[#ddd6cc] bg-white p-5 shadow-sm transition hover:-translate-y-1 hover:shadow-md"
            >
              <div className="flex items-start justify-between gap-3">
                <span className="rounded-md bg-[#edf2ef] px-3 py-1 text-xs font-bold text-[#2f6f5e]">
