        ...
        <section className="grid gap-8 py-8 lg:grid-cols-[1fr_420px] lg:items-center">
          <div className="max-w-3xl">
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              <Link
                href="/travel/items"
                className="inline-flex items-center gap-2 rounded-md bg-[#5ca1e6] px-5 py-3 text-sm font-bold text-white shadow-sm transition hover:bg-[#276965]"
              >
                여행리뷰 전체보기
                <ArrowRight size={18} />
              </Link>
